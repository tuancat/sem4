 ...
 * @author cattuan
 */
@WebServlet(name = "SiteClassDetailServlet", urlPatterns = {"/detail-siteclass"})
public class SiteClassDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        SiteClass currSiteClass = siteClassDao.findOne(id);
        List<Trainee> listTrainee = currSiteClass.getListTrainee();
        request.setAttribute("listTrainee", listTrainee);
        request.setAttribute("name", currSiteClass.getName());

        RequestDispatcher rd = getServletContext().getRequestDispatcher("/detail-siteclass.jsp");
